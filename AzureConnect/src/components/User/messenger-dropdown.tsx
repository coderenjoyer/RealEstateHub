      ...
      messages: [
        {
          id: 1,
          sender: "them",
          text: "Hi! I have some great properties that match your criteria",
          time: "6:20 PM",
        },
        {
          id: 2,
          sender: "me",
          text: "That sounds interesting! What areas are you focusing on?",
          time: "6:23 PM",
        },
        {
          id: 3,
          sender: "them",
          text: "I have listings in BGC, Makati, and Ortigas. All premium locations",
          time: "6:25 PM",
        },
        {
          id: 4,
          sender: "them",
          text: "Would you like to schedule a viewing this weekend?",
          time: "6:26 PM",
        },
      ],
    },
      ...
      messages: [
        {
          id: 1,
          sender: "them",
          text: "Mike Chen shared a new investment opportunity in Cebu",
          time: "6:15 PM",
        },
      ],
    },
      ...
      messages: [
        {
          id: 1,
          sender: "them",
          text: "New luxury condo in BGC - 3BR, 2BA, ₱15M. Interested?",
          time: "6:10 PM",
        },
      ],
    },
      ...
      messages: [
        {
          id: 1,
          sender: "them",
          text: "Your rental property maintenance is scheduled for tomorrow at 9 AM",
          time: "5:55 PM",
        },
      ],
    },
    {
      ...
      messages: [
        ...
        },
        {
          id: 2,
          sender: "them",
          text: "Your loan pre-approval is ready! Let's discuss the next steps",
          time: "6:45 PM",
        },
        {
          id: 3,
          sender: "me",
          text: "Great! I'll call you back in a few minutes",
          time: "6:46 PM",
        },
      ],
    },
      ...
      messages: [
        {
          id: 1,
          sender: "me",
          text: "Thanks for the market insights! Very helpful",
          time: "6:30 PM",
          reactions: [],
        },
      ],
      ...
      messages: [
        {
          id: 1,
          sender: "them",
          text: "Hey! Are you still interested in the BGC penthouse?",
          time: "5:00 PM",
          reactions: [],
        },
        {
          id: 2,
          sender: "me",
          text: "Yes! I'd love to schedule a viewing. When's available?",
          time: "5:01 PM",
          reactions: [],
        },
        {
          id: 3,
          sender: "them",
          text: "I have slots this weekend. Saturday 2 PM or Sunday 10 AM?",
          time: "5:02 PM",
          reactions: [],
        },
        {
          id: 4,
          sender: "me",
          text: "Saturday 2 PM works perfectly for me!",
          time: "5:03 PM",
          reactions: [],
        },
        {
          id: 5,
          sender: "them",
          text: "Great! I'll send you the address and parking details",
          time: "5:04 PM",
          reactions: [],
        },
        {
          id: 6,
          sender: "me",
          text: "Perfect! What's the asking price again?",
          time: "5:05 PM",
          reactions: [],
        },
        {
          id: 7,
          sender: "them",
          text: "It's ₱18M negotiable. The owner is motivated to sell",
          time: "5:06 PM",
          reactions: [],
        },
        {
          id: 8,
          sender: "me",
          text: "That's within my budget range. What about the HOA fees?",
          time: "5:07 PM",
          reactions: [],
        },
        {
          id: 9,
          sender: "them",
          text: "HOA is ₱8,500/month. Includes gym, pool, and 24/7 security",
          time: "5:08 PM",
          reactions: [],
        },
        {
          id: 10,
          sender: "me",
          text: "That's reasonable for the amenities. How old is the building?",
          time: "5:09 PM",
          reactions: [],
        },
        {
          id: 11,
          sender: "them",
          text: "Built in 2018, so it's relatively new. All modern fixtures",
          time: "5:10 PM",
          reactions: [],
        },
        {
          id: 12,
          sender: "me",
          text: "Excellent! What about the view from the unit?",
          time: "5:11 PM",
          reactions: [],
        },
        {
          id: 13,
          sender: "them",
          text: "It has a stunning city view! Floor-to-ceiling windows",
          time: "5:12 PM",
          reactions: [],
        },
        {
          id: 14,
          sender: "me",
          text: "Sounds amazing! I'm really looking forward to the viewing",
          time: "5:13 PM",
          reactions: [],
        },
        {
          id: 15,
          sender: "them",
          text: "I'll also bring the floor plans and recent comparable sales",
          time: "5:14 PM",
          reactions: [],
        },
        {
          id: 16,
          sender: "me",
          text: "That would be very helpful. Thank you for being so thorough!",
          time: "5:15 PM",
          reactions: [],
        },
        {
          id: 17,
          sender: "them",
          text: "My pleasure! I want to make sure you have all the information you need",
          time: "5:16 PM",
          reactions: [],
        },
        {
          id: 18,
          sender: "me",
          text: "I appreciate that. This could be the perfect home for us",
          time: "5:17 PM",
          reactions: [],
        },
        {
          id: 19,
          sender: "them",
          text: "I have a good feeling about this one! See you Saturday",
          time: "5:18 PM",
          reactions: [],
        },
        {
          id: 20,
          sender: "me",
          text: "Looking forward to it! Should I bring anything specific?",
          time: "5:19 PM",
          reactions: [],
        },
        {
          id: 21,
          sender: "them",
          text: "Just bring a valid ID and your pre-approval letter if you have one",
          time: "5:20 PM",
          reactions: [],
        },
        {
          id: 22,
          sender: "me",
          text: "Perfect! I have both ready. See you at 2 PM",
          time: "5:21 PM",
          reactions: [],
        },
        {
          id: 23,
          sender: "them",
          text: "Great! I'll text you the exact address and building access code",
          time: "5:22 PM",
          reactions: [],
        },
        {
          id: 24,
          sender: "me",
          text: "Thank you! I'm excited to see this property",
          time: "5:23 PM",
          reactions: [],
        },
        {
          id: 25,
          sender: "them",
          text: "Me too! It's one of my favorite listings right now",
          time: "5:24 PM",
          reactions: [],
        },
        {
          id: 26,
          sender: "me",
          text: "That's a great sign! Talk to you soon",
          time: "5:25 PM",
          reactions: [],
        },
        {
          id: 27,
          sender: "them",
          text: "Have a great evening! See you Saturday",
          time: "5:26 PM",
          reactions: [],
        },
        {
          id: 28,
          sender: "me",
          text: "You too! Thanks again for everything",
          time: "5:27 PM",
          reactions: [],
        },
        {
          id: 29,
          sender: "them",
          text: "My pleasure! Looking forward to showing you the penthouse",
          time: "5:28 PM",
          reactions: [],
        },
        {
          id: 30,
          sender: "me",
          text: "Same here! Have a wonderful evening",
          time: "5:29 PM",
          reactions: [],
        },
        {
          id: 31,
          sender: "them",
          text: "Thank you! See you Saturday at 2 PM",
          time: "5:30 PM",
          reactions: [],
        },
        {
          id: 32,
          sender: "me",
          text: "Perfect! Have a great rest of your day",
          time: "5:31 PM",
          reactions: [],
        },
        {
        ...
        },
        {
          id: 34,
          sender: "me",
          text: "Looking forward to it! Take care",
          time: "5:33 PM",
          reactions: [],
        },
        {
          id: 35,
          sender: "them",
          text: "Same here! See you Saturday",
          time: "5:34 PM",
          reactions: [],
        },
      ],
