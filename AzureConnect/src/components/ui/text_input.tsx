...
const TextInput: React.FC<InputProps> = ({
  ...
  const inputClasses = [
    "w-full rounded-[10px] border border-[#a8c1d3] bg-[#b8cfdd]/60",
    "placeholder:text-white/80 text-gray-600 px-4 py-3",
    "focus:outline-none focus:ring-2 focus:ring-[#5d8ab0] focus:border-transparent",
    leftIcon && "pl-10",
    isPassword && "pr-12",
    className
  ].filter(Boolean).join(" ");
