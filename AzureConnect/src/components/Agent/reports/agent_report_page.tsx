...
export default function EnhancedReportsPage() {
  ...
  const handleMarkAsResolved = async () => {
    if (
      !selectedReport ||
      !selectedReport.ownerId ||
      !selectedReport.propertyOwnershipId
    ) {
    ...
    try {
      ...
      if (logError) {
        throw new Error(
          `Failed to update maintenance log: ${logError.message}`
        );
      }
      ...
      if (ownershipError) {
        throw new Error(
          `Failed to update property ownership: ${ownershipError.message}`
        );
      }
      ...
      setResolveError(
        err.message || "Failed to mark report as resolved. Please try again."
      );
    } finally {
  ...
  return (
    <AgentLayout>
        ...
        <div className="max-w-7xl min-w-[375px] mx-auto">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-gray-700">
              Manage and track all reported issues and complaints
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-4">
                <div className="relative w-full sm:flex-1 sm:max-w-md">
                  ...
                  <input
                    ...
                    className="w-full pl-9 sm:pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#49769F] focus:border-transparent text-sm sm:text-base"
                  />
                </div>
                <div className="flex gap-2 w-full sm:w-auto">
                  <button
                    onClick={() => setShowFilters(!showFilters)}
                    className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium hover:bg-gray-100 transition-colors text-sm sm:text-base"
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#49769F] bg-white text-sm sm:text-base"
                    >
            ...
            <div className="overflow-x-auto">
              {fetchError && (
                <div className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-red-600 bg-red-50 border-b border-red-100">
                  {fetchError}
                </div>
              )}
              {loadingReports && !fetchError && (
                <div className="px-4 sm:px-6 py-10 text-center text-gray-500 text-sm sm:text-base">
                  ...
                  {paginatedData.map((report) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-3 sm:px-6 py-3 sm:py-4">
                          <div>
                            <p className="text-xs sm:text-sm font-medium text-gray-900">
                              {report.ownerName || "Unknown Owner"}
                            </p>
                        ...
                        <td className="px-3 sm:px-6 py-3 sm:py-4">
                          <p className="text-xs sm:text-sm text-gray-700 line-clamp-2 max-w-xs">
                            {report.details}
                          </p>
                          {report.propertyTitle && (
                            <p className="text-xs text-[#49769F] mt-1">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between p-4 sm:p-6 border-t border-gray-200 gap-3 sm:gap-0">
                ...
                <div className="flex gap-2 flex-wrap justify-center">
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-xs sm:text-sm"
                  >
                    Previous
                  </button>
      ...
      {isModalOpen && selectedReport && (
        ...
        >
          <div
            className="w-full max-w-3xl mx-4 bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-hidden flex flex-col"
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  {selectedReport.propertyId && (
                    <>
                      <div>
                        ...
                        <p className="text-sm sm:text-base text-[#49769F] font-mono">
                          {selectedReport.propertyId}
                        </p>
                      </div>
                      <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    <label className="text-xs sm:text-sm font-semibold text-gray-700 mb-1 flex items-center gap-2">
                  ...
                  {selectedReport.attachments && (
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-[#49769F]">
                        {selectedReport.attachments} file(s)
                      </p>
                    </div>
                  )}
                </div>
            ...
            {/* Modal Actions */}
            <div className="border-t border-gray-200 px-4 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row gap-3 justify-end bg-gray-50">
              <button
                onClick={closeModal}
                className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-white transition-colors text-sm sm:text-base"
              >
                Close
              </button>
              {selectedReport.status === "Pending" && (
                <>
                  <button
                    ...
                    className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 justify-center text-sm sm:text-base"
                  >
                    {resolvingReport ? (
                      <>
